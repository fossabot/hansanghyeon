...
import { ImageTooltip, ImageTooltipFor, Title } from './style';
        ...
        <ul>
          <li>
            ...
            <ImageTooltip id="mbc" effect="solid" aria-haspopup="true">
              <img
                src="https://wp.hapas.io/wp-content/uploads/mbc.png"
                alt=""
              />
            </ImageTooltip>
            <p>
  ...
  return (
    <div>
      ...
      <div>
        <ul>
          <li>
            <Title>intonomad 인투노마드</Title> <DimSpan>2018-12</DimSpan>
            <p>
              <a
          ...
          <li>
            ...
            <ImageTooltip id="sitech" effect="solid" aria-haspopup="true">
              <img
                src="https://wp.hapas.io/wp-content/uploads/4log/project/00.png"
                alt=""
              />
            </ImageTooltip>
            <p>
          ...
          <li>
            <Title>GE Additive Day 2019 이벤트</Title>{' '}
          ...
          <li>
            <Title>빌딩 스토어</Title> <DimSpan>(2019-05)</DimSpan>
            <p>
              <a
          ...
          <li>
            ...
            <ImageTooltip id="porsche" effect="solid" aria-haspopup="true">
              <img
                src="https://wp.hapas.io/wp-content/uploads/4log/project/porsche_title.jpg"
                alt=""
              />
            </ImageTooltip>
            <p>
          ...
          <li>
            ...
            <ImageTooltip id="sitech" effect="solid" aria-haspopup="true">
              <img
                src="https://wp.hapas.io/wp-content/uploads/4log/project/00-1.png"
                alt=""
              />
            </ImageTooltip>
            <p>
          ...
          <li>
            <Title>INR</Title> <DimSpan>(2019-09)</DimSpan>
            <p>
              <a
          ...
          <li>
            ...
            <ImageTooltip id="vatecheng" effect="solid" aria-haspopup="true">
              <img
                src="https://wp.hapas.io/wp-content/uploads/4log/project/vatecheng_title.jpg"
                alt=""
              />
            </ImageTooltip>
            <p>
